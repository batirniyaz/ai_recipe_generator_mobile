...
class PremiumUserPage extends StatefulWidget {
  ...
  @override
  _PremiumUserPageState createState() => _PremiumUserPageState();
}
...
class _PremiumUserPageState extends State<PremiumUserPage> {
  ...
  Future<void> _sendMessage() async {
    ...
    try {
      final response = await http.post(
        Uri.parse('http://13.60.63.216/recipe_premium_version'),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Premium User Recipes'),
        ...
        child: Column(
          children: [
            Padding(
              ...
              child: Text(
                'Welcome to the Premium User Page',
